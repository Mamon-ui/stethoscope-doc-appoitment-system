        ...
        <div class="hero">
            <div class="from-box">
                ...
                <form id="login" class="input-group" onsubmit = "return validation()" method = "POST">
                    <input type="email" class="input-field" placeholder="Email Id" name="userId" required>
                ...
                <form id="register" class="input-group2" action="insert.php" method="post">
                    ...
                    <input type="number" class="input-field" placeholder="Enter Age" name="age" required>
                    <input type="email" class="input-field" placeholder="Enter your email ID" name="userId" required>
