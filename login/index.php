...
<section class="doctors" id="doctors">
    ...
    <div class="box-container">
        ...
        <div class="box">
        <i class="fas fa-user-md"></i>
            <h3>Dr. KASHINATH GHOSH HAZRA</h3>
            <span>expert doctor</span>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="#"> <i class="fas fa-envelope"></i> sunnybanerjee0707@gmail.com </a>
            <a href="#"> <i class="fas fa-envelope"></i> dsandip2233@gmail.com </a>
            <a href="#"> <i class="fas fa-map-marker-alt"></i> kolkata, india - 700001 </a>
        </div>
